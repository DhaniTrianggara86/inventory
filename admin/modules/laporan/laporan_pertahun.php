...
<h3 align="center"><span class="fa fa-file-text-o"></span>  Laporan Pemesanan Per Tahun</h3>
 <div class="row">
                <div class="col-md-4" style="margin-left: 10px;">
                    <div class="panel panel-default">
                        <div class="panel-heading">
						<form name="f1" method=post action="modules/laporan/cetakpertahun.php" target="_blank">
